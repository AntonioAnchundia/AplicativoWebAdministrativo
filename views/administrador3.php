        ...
        <div class="form first">                
            <div class="fields" id="formulario">
                ...
                <div class="formulario__grupo" id="grupo__EmailAdmin">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="email" class="formulario__input" name="EmailAdmin" id="EmailAdmin" maxlength="30" placeholder="Correo Electrónico">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                ...
                <div class="formulario__grupo" id="grupo__DireccionAdmin">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" name="DireccionAdmin" id="DireccionAdmin" maxlength="30" placeholder="Dirección">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    <p class="formulario__input-error"> Complete este campo</p>
                </div>
                ...
                <div class="formulario__grupo" id="grupo__ContraseñaAdmin">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="password" class="formulario__input" name="ContraseñaAdmin" id="ContraseñaAdmin" maxlength="15" placeholder="Contraseña">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                ...
                <div class="formulario__grupo" id="grupo__ConfirmarContraseña">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="password" class="formulario__input" name="ConfirmarContraseña" id="ConfirmarContraseña" maxlength="15" placeholder="Repetir Contraseña">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
